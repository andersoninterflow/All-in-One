...
class HealthPostgresStore(BasePostgresStore):
    """Production Health adapter backed by typed PostgreSQL relations and central audit/outbox."""

    module = "health"
    backend = "postgres_health_typed_store"
    tables = {
    ...
    soft_deletable = frozenset(['patients', 'appointments', 'medical_records', 'prescriptions', 'beds'])
